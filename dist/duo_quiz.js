          ...
          if (expected[i] != '.') {
            if (expected[i] instanceof duoquiz.Reference) {
              ...
              if (compareValue != actual[i]) {
                result.correct = false;
                result.errorcount++;
                result.msg[result.errorcount] = duoquiz.lang.str(_lang, 'expected') + ': ' + compareValue + ' ' + duoquiz.lang.str(_lang, 'actual') + ': ' + actual[i];
              }
            } else if (expected[i] != actual[i]) {
              result.correct = false;
              result.errorcount++;
              result.msg[result.errorcount] = duoquiz.lang.str(_lang, 'expected') + ': ' + expected[i] + ' ' + duoquiz.lang.str(_lang, 'actual') + ': ' + actual[i];
            }
          }
        }
      }
