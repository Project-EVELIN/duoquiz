...
case 4:WHITE_RETURN('\n');
break;
case 5: return(PA_KEYWORD_RETURN(parser.symbols_.LE_AUTO));
break;
case 6: return(PA_KEYWORD_RETURN(parser.symbols_.LE_BREAK));
break;
case 7: return(PA_KEYWORD_RETURN(parser.symbols_.LE_CASE));
break;
case 8: return(PA_KEYWORD_RETURN(parser.symbols_.LE_CHAR));
break;
case 9: return(PA_KEYWORD_RETURN(parser.symbols_.LE_CONST));
break;
case 10: return(PA_KEYWORD_RETURN(parser.symbols_.LE_CONTINUE));
break;
case 11: return(PA_KEYWORD_RETURN(parser.symbols_.LE_DEFAULT));
break;
case 12: return("define");
break;
case 13: return("defined");
break;
case 14: return(PA_KEYWORD_RETURN(parser.symbols_.LE_DO));
break;
case 15: return(PA_KEYWORD_RETURN(parser.symbols_.LE_DOUBLE));
break;
case 16: return("elif");
break;
...
break;
case 20: return(PA_KEYWORD_RETURN(parser.symbols_.LE_ENUM));
break;
case 21: return(PA_KEYWORD_RETURN(parser.symbols_.LE_EXTERN));
break;
case 22: return(PA_KEYWORD_RETURN(parser.symbols_.LE_FLOAT));
break;
case 23: return(PA_KEYWORD_RETURN(parser.symbols_.LE_FOR));
break;
case 24: return(PA_KEYWORD_RETURN(parser.symbols_.LE_GOTO));
break;
case 25: return(PPPA_KEYWORD_RETURN(parser.symbols_.LE_IF));
break;
case 26: return("ifdef");
break;
case 27: return("ifndef");
break;
case 28: return(PP_KEYWORD_RETURN(parser.symbols_.LE_INCLUDE));
break;
case 29: return(PA_KEYWORD_RETURN(parser.symbols_.LE_INT));
break;
case 30: return("line");
break;
case 31: return(PA_KEYWORD_RETURN(parser.symbols_.LE_LONG));
break;
case 32: return(PA_KEYWORD_RETURN(parser.symbols_.LE_BOOL));
break;
case 33: return("pragma");
break;
case 34: return(PA_KEYWORD_RETURN(parser.symbols_.LE_REGISTER));
break;
case 35: return(PA_KEYWORD_RETURN(parser.symbols_.LE_RETURN));
break;
case 36: return(PA_KEYWORD_RETURN(parser.symbols_.LE_SHORT));
break;
case 37: return(PA_KEYWORD_RETURN(parser.symbols_.LE_SIGNED));
break;
case 38: return(PA_KEYWORD_RETURN(parser.symbols_.LE_SIZEOF));
break;
case 39: return(PA_KEYWORD_RETURN(parser.symbols_.LE_STATIC));
break;
case 40: return(PA_KEYWORD_RETURN(parser.symbols_.LE_STRUCT));
break;
case 41: return(PA_KEYWORD_RETURN(parser.symbols_.LE_SWITCH));
break;
case 42: return(PA_KEYWORD_RETURN(parser.symbols_.LE_TYPEDEF));
break;
case 43: return("undef");
break;
case 44: return(PA_KEYWORD_RETURN(parser.symbols_.LE_UNION));
break;
case 45: return(PA_KEYWORD_RETURN(parser.symbols_.LE_UNSIGNED));
break;
case 46: return(PA_KEYWORD_RETURN(parser.symbols_.LE_VOID));
break;
case 47: return(PA_KEYWORD_RETURN(parser.symbols_.LE_VOLATILE));
break;
case 48: return(PA_KEYWORD_RETURN(parser.symbols_.LE_WHILE));
break;
case 49:PA_KEYWORD_RETURN("time_t");
break;
case 50:PA_KEYWORD_RETURN("size_t");
break;
case 51: return(CPP_KEYWORD_RETURN(parser.symbols_.LE_CLASS));
break;
case 52: return(CPP_KEYWORD_RETURN(parser.symbols_.LE_NAMESPACE));
break;
case 53: return(CPP_KEYWORD_RETURN(parser.symbols_.LE_DELETE));
break;
case 54: return(CPP_KEYWORD_RETURN(parser.symbols_.LE_FRIEND));
break;
case 55: return(CPP_KEYWORD_RETURN(parser.symbols_.LE_INLINE));
break;
case 56: return(CPP_KEYWORD_RETURN(parser.symbols_.LE_NEW));
break;
case 57: return(CPP_KEYWORD_RETURN(parser.symbols_.LE_OPERATOR));
break;
case 58: return(CPP_KEYWORD_RETURN(parser.symbols_.LE_OVERLOAD));
break;
case 59: return(CPP_KEYWORD_RETURN(parser.symbols_.LE_PROTECTED));
break;
case 60: return(CPP_KEYWORD_RETURN(parser.symbols_.LE_PRIVATE));
break;
case 61: return(CPP_KEYWORD_RETURN(parser.symbols_.LE_PUBLIC));
break;
case 62: return(CPP_KEYWORD_RETURN(parser.symbols_.LE_THIS));
break;
case 63: return(CPP_KEYWORD_RETURN(parser.symbols_.LE_VIRTUAL));
break;
case 64: return(CPP_KEYWORD_RETURN(parser.symbols_.LE_TEMPLATE));
break;
case 65: return(CPP_KEYWORD_RETURN(parser.symbols_.LE_TYPENAME));
break;
case 66:return(CPP_KEYWORD_RETURN(parser.symbols_.LE_DYNAMIC_CAST));
break;
case 67:return(CPP_KEYWORD_RETURN(parser.symbols_.LE_STATIC_CAST));
break;
case 68:return(CPP_KEYWORD_RETURN(parser.symbols_.LE_CONST_CAST));
break;
case 69:return(CPP_KEYWORD_RETURN(parser.symbols_.LE_REINTERPRET_CAST));
break;
case 70:return(CPP_KEYWORD_RETURN(parser.symbols_.LE_USING));
break;
case 71:return(CPP_KEYWORD_RETURN(parser.symbols_.LE_THROW));
break;
case 72:return(CPP_KEYWORD_RETURN(parser.symbols_.LE_CATCH));
break;
case 73:return(CPP_KEYWORD_RETURN("__declspec"));
break;
case 74:return(CPP_KEYWORD_RETURN("dllimport"));
break;
case 75:return(CPP_KEYWORD_RETURN("dllexport"));
break;
case 76: return(IDENTIFIER_RETURN());
break;
case 77:return parser.symbols_.LE_INTEGERconstant;
break;
case 78:return parser.symbols_.LE_OCTALconstant;
break;
case 79:return parser.symbols_.LE_HEXconstant;
break;
case 80:return parser.symbols_.LE_FLOATINGconstant;
break;
case 81:return parser.symbols_.LE_CHARACTERconstant;
break;
case 82:return parser.symbols_.LE_STRINGliteral;
break;
case 83: return(NAMEDOP_RETURN(parser.symbols_.LE_ELLIPSIS));
break;
case 84: return(NAMEDOP_RETURN(parser.symbols_.LE_RSassign));
break;
case 85: return(NAMEDOP_RETURN(parser.symbols_.LE_LSassign));
break;
case 86: return(NAMEDOP_RETURN(parser.symbols_.LE_PLUSassign));
break;
case 87: return(NAMEDOP_RETURN(parser.symbols_.LE_MINUSassign));
break;
case 88: return(NAMEDOP_RETURN(parser.symbols_.LE_MULTassign));
break;
case 89: return(NAMEDOP_RETURN(parser.symbols_.LE_DIVassign));
break;
case 90: return(NAMEDOP_RETURN(parser.symbols_.LE_MODassign));
break;
case 91: return(NAMEDOP_RETURN(parser.symbols_.LE_ANDassign));
break;
case 92: return(NAMEDOP_RETURN(parser.symbols_.LE_ERassign));
break;
case 93: return(NAMEDOP_RETURN(parser.symbols_.LE_ORassign));
break;
case 94: return(NAMEDOP_RETURN(parser.symbols_.LE_RS));
break;
case 95: return(NAMEDOP_RETURN(parser.symbols_.LE_LS));
break;
case 96: return(NAMEDOP_RETURN(parser.symbols_.LE_ICR));
break;
case 97: return(NAMEDOP_RETURN(parser.symbols_.LE_DECR));
break;
case 98: return(NAMEDOP_RETURN(parser.symbols_.LE_ARROW));
break;
case 99: return(NAMEDOP_RETURN(parser.symbols_.LE_ARROWstar));
break;
case 100: return(NAMEDOP_RETURN(parser.symbols_.LE_ANDAND));
break;
case 101: return(NAMEDOP_RETURN(parser.symbols_.LE_OROR));
break;
case 102: return(NAMEDOP_RETURN(parser.symbols_.LE_LE));
break;
case 103: return(NAMEDOP_RETURN(parser.symbols_.LE_GE));
break;
case 104: return(NAMEDOP_RETURN(parser.symbols_.LE_EQ));
break;
case 105: return(NAMEDOP_RETURN(parser.symbols_.LE_NE));
break;
case 106: return(NAMEDOP_RETURN(parser.symbols_.LE_DOTstar));
break;
case 107: return(NAMEDOP_RETURN(parser.symbols_.LE_CLCL));
break;
...
break;
case 112: return(ASCIIOP_RETURN(':'));
break;
case 113: return(ASCIIOP_RETURN('='));
break;
case 114: return(PPOP_RETURN('('));
break;
case 115: return(PPOP_RETURN(')'));
break;
case 116: return(ASCIIOP_RETURN('['));
break;
case 117: return(ASCIIOP_RETURN(']'));
break;
case 118: return(ASCIIOP_RETURN('.'));
break;
case 119: return(ASCIIOP_RETURN('&'));
break;
case 120: return(ASCIIOP_RETURN('!'));
break;
case 121: return(ASCIIOP_RETURN('~'));
break;
case 122: return(ASCIIOP_RETURN('-'));
break;
case 123: return(ASCIIOP_RETURN('+'));
break;
case 124: return(ASCIIOP_RETURN('*'));
break;
case 125: return(ASCIIOP_RETURN('/'));
break;
case 126: return(ASCIIOP_RETURN('%'));
break;
case 127: return(ASCIIOP_RETURN('<'));
break;
case 128: return(ASCIIOP_RETURN('>'));
break;
case 129: return(ASCIIOP_RETURN("^"));
break;
case 130: return(ASCIIOP_RETURN('|'));
break;
