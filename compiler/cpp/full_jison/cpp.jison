...
comma_expression:
        assignment_expression  {$$ = $1;}
        | comma_expression ',' assignment_expression  {$$ = $1 + "," + $3;}
        ;
...
default_declaring_list:
        declaration_qualifier_list   identifier_declarator initializer_opt {$$ = $1 + $2 + $3;}
        | type_qualifier_list        identifier_declarator initializer_opt {$$ = $1 + $2 + $3;}
        | default_declaring_list ',' identifier_declarator initializer_opt {$$ = $1 + "," + $3 + $4;}
        ...
        | default_declaring_list ',' constructed_identifier_declarator {$$ = $1 + "," + $3;}
        ;
...
compound_statement:
        '{' statement_list_opt '}' {$$ = $1.concat($2, $3);}
        ;
...
scope:
        scoping_name LE_CLCL {$$ = $1.concat($2);}
        | scope scoping_name  LE_CLCL {$$ = $1.concat($2, $3);}
        ;
...
scoped_typedefname:
        scope LE_TYPEDEFname {$$ = $1.concat($2);}
        ;
