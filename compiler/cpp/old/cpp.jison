...
paren_identifier_declarator:
        scope_opt_identifier {$$ = $1; yy.parser.logRule("paren_identifier_declarator:scope_opt_identifier");}
        | scope_opt_complex_name {$$ = $1; yy.parser.logRule("paren_identifier_declarator:scope_complex_name");}
        | '(' paren_identifier_declarator ')' {$$ = [$1, $2, $3]; yy.parser.logRule("paren_identifier_declarator:braced_paren_identifier_declarator");}
        ;
...
identifier_declarator:
        unary_identifier_declarator { $$ = $1; yy.parser.logRule("identifier_declarator:unary_identifier_declarator");}
        | paren_identifier_declarator {$$ = $1; yy.parser.logRule("identifier_declarator:paren_identifier_declarator");}
        ;
...
scope_opt_identifier:
        identifier {$$ = $1; yy.parser.logRule("scope_opt_identifier:identifier");}
        | scope identifier {$$ = [$1, $2];yy.parser.logRule("scope_opt_identifier:scope identifier")}
        ;
